  ...
  const projects = [
    {
      title: "chat App",
      description:
        "Developed a real-time multi-user chat app with rooms and instant messaging using Socket.IO. Implemented server-side event handling and client-side UI with plain JavaScript and HTMLCSS. Features include room message broadcasting",
      techStack: ["HTML", "CSS", "Node.js", "Express.js"],
      link: "https://github.com/Divyyy/Chatapp",
      live: "https://chatapp001.onrender.com/", 
    },
    {
